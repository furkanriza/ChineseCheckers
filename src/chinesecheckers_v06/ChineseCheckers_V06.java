...
public class ChineseCheckers_V06
{
    ...
    public static void main(String[] args) throws CloneNotSupportedException
    {
        ...
        //BoardGameAgent agent1 = new ChineseCheckerMoronAgent(20);
        BoardGameAgent agent1 = new ChineseCheckerCustomAgent(-472574);

        //BoardGameAgent agent2 = new ChineseCheckerIdiotAgent();
        //BoardGameAgent agent2 = new ChineseCheckerImbecileAgent();
        BoardGameAgent agent2 = new ChineseCheckerMoronAgent(10);
        //BoardGameAgent agent2 = new ChineseCheckerCustomAgent(-514651);
